    ...
    <div class="w-full max-w-sm bg-gray-200 rounded-lg shadow-md p-4 mx-auto relative">
        ...
        <div class="flex flex-col">
            ...
            <div v-if="showTodos" class="w-full max-w-sm bg-gray-100 rounded-lg shadow-md p-1 mx-auto relative mb-2">
                <div class="text-sm mb-2 overflow-x-auto pl-6 max-h-20">
        ...
        <div class="w-full flex justify-around">
            ...
            <button type="button" @click.prevent="closeItem" class="w-fit text-white py-1 px-2 rounded-md transition"
                :class="itemCloseable ? 'bg-emerald-600 hover:bg-emerald-800' : 'bg-gray-400 hover:bg-gray-600 line-through cursor-not-allowed'"
